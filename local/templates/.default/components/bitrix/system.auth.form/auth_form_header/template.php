...
<ul class="flex justify-center sm:justify-end items-center space-x-8 text-sm">
    ...
    <li>
        <a class="text-gray-500 hover:text-orange" href="<?=$arParams['REGISTER_URL'] . '?backurl=' . $arResult['BACKURL']?>">
...
<nav class="flex justify-center sm:justify-end items-center space-x-8 text-sm">
    <a class="text-black hover:text-orange" href="<?=$arParams['PROFILE']?>">
        ...
        <span class="inline-block font-bold"><?=GetMessage('HELLO') . ', ' . $arResult['USER_NAME']?></span>
    </a>
    ...
    <a class="text-gray-500 hover:text-orange" href="<?=$APPLICATION->GetCurPageParam("logout=yes&" . bitrix_sessid_get(), array(
        "login",
        "logout",
        "register",
        "forgot_password",
