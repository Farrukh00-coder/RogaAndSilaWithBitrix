...
<?endif?>
				<input type="password" name="USER_PASSWORD" maxlength="255" value="<?=$arResult["USER_PASSWORD"]?>" placeholder="<?=GetMessage('PASS_PLACEHOLDER')?>" autocomplete="off" />
				
				<div class="bx-authform-description-container">
					<?=GetMessage('PASSWORD_REQUIREMENTS')?>
				</div>
			</div>
		</div>
...
<?endif?>
				<input type="password" name="USER_CONFIRM_PASSWORD" maxlength="255" value="<?=$arResult["USER_CONFIRM_PASSWORD"]?>" placeholder="<?=GetMessage('PASS_PLACEHOLDER')?>" autocomplete="off" />
			</div>
		</div>
...
<?endif?>
		...
		<div class="bx-authform-description-container">
			<span class="bx-authform-starrequired">*</span><?=GetMessage('AUTH_LOGIN_REQ')?>
		</div>
		...
		<div class="bx-authform-description-container">
			<span class="bx-authform-starrequired">*</span><?=GetMessage('CAPTCHA')?>
		</div>
